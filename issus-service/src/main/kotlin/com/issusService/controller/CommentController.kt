...
import com.issusService.service.CommentService
...
class CommentController (
    ...
    fun create(authUser: AuthUser,
               ...
               @RequestBody request: CommentRequest) : CommentResponse {
    ...
    fun update(authUser: AuthUser,
               ...
               @RequestBody request: CommentRequest) = commentService.edit(id, authUser.userId, request)

    @DeleteMapping("/{id}")
    @ResponseStatus(HttpStatus.NO_CONTENT)
    fun delete(authUser: AuthUser,
               @PathVariable issueId: Long,
               @PathVariable id: Long,
